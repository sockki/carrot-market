...
export default function Enter() {
  ...
  return (
    <div className="mt-16 px-4 max-w-2xl m-auto">
          ...
          <>
              ...
              <div className="grid border-b w-full mt-8 grid-cols-2 gap-16">
                <button
                  className={cls(
                    ...
                    method === "email"
                      ? "font-semibold border-orange-500 text-orange-400"
            ...
            >
              ...
              <div className="mt-8">
                {method === "email" ? (
                  <Suspense fallback={<Skeleton />}>
                    <Button name={loading ? "Loading" : "Get login link"} />
                  </Suspense>
                ) : null}
                {method === "phone" ? (
                  <Suspense fallback={<Skeleton />}>
                    <Button name={loading ? "Loading" : "Get one-time password"}/>
                  </Suspense>
                ) : null}
              </div>
            </form>
