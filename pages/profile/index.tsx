  ...
  return (
    <>
      {data?.reviews?.map((rev) => (
        <div key={rev?.id} className="mt-12">
              ...
              <div className="flex items-center">
                {[1, 2, 3, 4, 5].map((star) => (
                  <svg
                    ...
                    className={cls(
                      "h-5 w-5",
                      rev.score >= star ? "text-yellow-400" : "text-gray-400"
                    )}
...
const Profile: NextPage = () => {
  return (
    <Layout seotitle={"Profile"} hasTabBar title="마이캐럿">
      <div className="py-10 px-4">
        <MiniProfile />
        <div className="mt-10 flex justify-around">
          <Link href={"/profile/sold"} legacyBehavior>
            <a className="flex flex-col items-center">
              <div className="w-16 h-16 text-white bg-orange-500 rounded-full flex items-center justify-center">
                <svg
                  className="w-6 h-6"
                  fill="none"
                  stroke="currentColor"
          ...
          <Link href={"/profile/buy"} legacyBehavior>
            <a className="flex flex-col items-center">
              <div className="w-16 h-16 text-white bg-orange-500 rounded-full flex items-center justify-center">
                <svg
                  className="w-6 h-6"
          ...
          <Link href={"/profile/love"} legacyBehavior>
            <a className="flex flex-col items-center">
              <div className="w-16 h-16 text-white bg-orange-500 rounded-full flex items-center justify-center">
                <svg
                  className="w-6 h-6"
